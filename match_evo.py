    ...
    for new_entry in entries_to_process:
        ...
        if best_match:
            ...
            matched_data.append({
                ...
                'new_translation_lineno_corr': new_entry.get('translation_lineno_corr'),
        ...
        for new_voice_entry in new_data:
            ...
            if matched_entry:
                rows_to_write.append([
                    ...
                    matched_entry['new_translation_lineno_corr'],
                ...
                if unmatched_entry:
                    rows_to_write.append([
                        ...
                        unmatched_entry['new_translation_lineno_corr'],
                        '',
                        '',
                        'unmatched',
                    ...
                    rows_to_write.append([
                        ...
                        skipped_entry['new_translation_lineno_corr'],
                        '',
                        '',
                        'skipped',
